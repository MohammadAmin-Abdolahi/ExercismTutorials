...
def higher_card(card_one, card_two):
    ...
    """
    cO=value_of_card(card_one)
    cT=value_of_card(card_two)
    if(cO > cT):
        return str(card_one)
    elif(cO == cT):
...
def value_of_ace(card_one, card_two):
    ...
    """
    cardO = value_of_card(card_one)
    cardT = value_of_card(card_two)
    if(card_one == 'A' or card_two == 'A' or cardO + cardT >= 11):
            return 1
    elif(cardO + cardT < 11):
        return 11
...
def is_blackjack(card_one, card_two):
    ...
    """
    cardOne = value_of_card(card_one)
    cardTwo = value_of_card(card_two)
    if(cardOne == 1 and cardTwo == 10):
        return True
    elif(cardOne == 10 and cardTwo == 1):
        return True
    else:
        return False
...
def can_double_down(card_one, card_two):
    ...
    cT=value_of_card(card_two)
    card_total = cO + cT
    if(9 <= card_total and 11 >= card_total):
        return True
